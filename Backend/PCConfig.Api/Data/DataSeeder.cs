    ...
    public static async Task SeedAsync(AppDbContext db)
    {
        ...
        var components = new List<Component>
        {
            ...
            new() { CategoryId = cat["motherboard"], Brand = "ASUS",     Name = "PRIME B550-PLUS",           Price = 109.99m,
                SpecsJson = S("AM4 Socket","ATX","DDR4 до 4400MHz","4× DDR4 слота","B550","PCIe 4.0","2x M.2","USB 3.2"),
                Socket = "AM4",     FormFactor = "ATX",  RamType = "DDR4", Chipset = "B550",  RamSlots = 4, Image = "img/motherboard/mb-1.png" },
            new() { CategoryId = cat["motherboard"], Brand = "MSI",      Name = "MAG B550 TOMAHAWK",         Price = 129.99m,
                SpecsJson = S("AM4 Socket","ATX","DDR4 до 4866MHz","4× DDR4 слота","B550","PCIe 4.0","2x M.2","2.5G LAN"),
                Socket = "AM4",     FormFactor = "ATX",  RamType = "DDR4", Chipset = "B550",  RamSlots = 4, Image = "img/motherboard/mb-2.png" },
            new() { CategoryId = cat["motherboard"], Brand = "Gigabyte", Name = "B550 AORUS Elite V2",       Price = 149.99m,
                SpecsJson = S("AM4 Socket","ATX","DDR4 до 5100MHz","4× DDR4 слота","B550","PCIe 4.0","2x M.2","WiFi 6"),
                Socket = "AM4",     FormFactor = "ATX",  RamType = "DDR4", Chipset = "B550",  RamSlots = 4, Image = "img/motherboard/mb-3.png" },

            // AM5 / DDR5 — Budget
            new() { CategoryId = cat["motherboard"], Brand = "MSI",      Name = "PRO B650-S WiFi",           Price = 149.99m,
                SpecsJson = S("AM5 Socket","ATX","DDR5 до 6400MHz","4× DDR5 слота","B650","PCIe 5.0","2x M.2","WiFi 6E"),
                Socket = "AM5",     FormFactor = "ATX",  RamType = "DDR5", Chipset = "B650",  RamSlots = 4, Image = "img/motherboard/mb-4.png" },
            new() { CategoryId = cat["motherboard"], Brand = "ASUS",     Name = "PRIME B650-PLUS",           Price = 159.99m,
                SpecsJson = S("AM5 Socket","ATX","DDR5 до 6400MHz","4× DDR5 слота","B650","PCIe 5.0","2x M.2","USB 3.2"),
                Socket = "AM5",     FormFactor = "ATX",  RamType = "DDR5", Chipset = "B650",  RamSlots = 4, Image = "img/motherboard/mb-5.png" },

            // AM5 / DDR5 — Mid
            new() { CategoryId = cat["motherboard"], Brand = "MSI",      Name = "MAG B650 TOMAHAWK WIFI",    Price = 219.99m,
                SpecsJson = S("AM5 Socket","ATX","DDR5 до 7200MHz","4× DDR5 слота","B650","PCIe 5.0","3x M.2","WiFi 6E"),
                Socket = "AM5",     FormFactor = "ATX",  RamType = "DDR5", Chipset = "B650",  RamSlots = 4, Image = "img/motherboard/mb-6.png" },
            new() { CategoryId = cat["motherboard"], Brand = "Gigabyte", Name = "B650 AORUS Elite AX",       Price = 239.99m,
                SpecsJson = S("AM5 Socket","ATX","DDR5 до 7600MHz","4× DDR5 слота","B650","PCIe 5.0","3x M.2","WiFi 6E"),
                Socket = "AM5",     FormFactor = "ATX",  RamType = "DDR5", Chipset = "B650",  RamSlots = 4, Image = "img/motherboard/mb-7.png" },
            new() { CategoryId = cat["motherboard"], Brand = "ASUS",     Name = "ROG Strix B650-A Gaming",   Price = 279.99m,
                SpecsJson = S("AM5 Socket","ATX","DDR5 до 7800MHz","4× DDR5 слота","B650","PCIe 5.0","4x M.2","2.5G LAN"),
                Socket = "AM5",     FormFactor = "ATX",  RamType = "DDR5", Chipset = "B650",  RamSlots = 4, Image = "img/motherboard/mb-8.png" },

            // AM5 / DDR5 — High-end
            new() { CategoryId = cat["motherboard"], Brand = "Gigabyte", Name = "X670E AORUS Master",        Price = 449.99m,
                SpecsJson = S("AM5 Socket","ATX","DDR5 до 8000MHz","4× DDR5 слота","X670E","PCIe 5.0 x2","5x M.2","WiFi 6E","Thunderbolt 4"),
                Socket = "AM5",     FormFactor = "ATX",  RamType = "DDR5", Chipset = "X670E", RamSlots = 4, Image = "img/motherboard/mb-9.png" },
            new() { CategoryId = cat["motherboard"], Brand = "ASUS",     Name = "ROG Crosshair X670E Hero",  Price = 499.99m,
                SpecsJson = S("AM5 Socket","ATX","DDR5 до 8000MHz","4× DDR5 слота","X670E","PCIe 5.0 x2","5x M.2","WiFi 6E","USB4"),
                Socket = "AM5",     FormFactor = "ATX",  RamType = "DDR5", Chipset = "X670E", RamSlots = 4, Image = "img/motherboard/mb-10.png" },

            // LGA1700 / DDR5 — Budget
            new() { CategoryId = cat["motherboard"], Brand = "MSI",      Name = "PRO B760M-E DDR5",          Price = 109.99m,
                SpecsJson = S("LGA1700 Socket","mATX","DDR5 до 7200MHz","4× DDR5 слота","B760","PCIe 4.0","2x M.2","USB 3.2"),
                Socket = "LGA1700", FormFactor = "mATX", RamType = "DDR5", Chipset = "B760",  RamSlots = 4, Image = "img/motherboard/mb-11.png" },
            new() { CategoryId = cat["motherboard"], Brand = "ASUS",     Name = "PRIME B760-PLUS DDR5",      Price = 149.99m,
                SpecsJson = S("LGA1700 Socket","ATX","DDR5 до 7200MHz","4× DDR5 слота","B760","PCIe 4.0","3x M.2","2.5G LAN"),
                Socket = "LGA1700", FormFactor = "ATX",  RamType = "DDR5", Chipset = "B760",  RamSlots = 4, Image = "img/motherboard/mb-12.png" },

            // LGA1700 / DDR5 — Mid/High
            new() { CategoryId = cat["motherboard"], Brand = "MSI",      Name = "MAG Z790 TOMAHAWK WIFI",    Price = 299.99m,
                SpecsJson = S("LGA1700 Socket","ATX","DDR5 до 7600MHz","4× DDR5 слота","Z790","PCIe 5.0","4x M.2","WiFi 6E"),
                Socket = "LGA1700", FormFactor = "ATX",  RamType = "DDR5", Chipset = "Z790",  RamSlots = 4, Image = "img/motherboard/mb-13.png" },
            new() { CategoryId = cat["motherboard"], Brand = "ASUS",     Name = "ROG Strix Z790-E Gaming",   Price = 349.99m,
                SpecsJson = S("LGA1700 Socket","ATX","DDR5 до 8000MHz","4× DDR5 слота","Z790","PCIe 5.0","5x M.2","Thunderbolt 4"),
                Socket = "LGA1700", FormFactor = "ATX",  RamType = "DDR5", Chipset = "Z790",  RamSlots = 4, Image = "img/motherboard/mb-14.png" },
            new() { CategoryId = cat["motherboard"], Brand = "Gigabyte", Name = "Z790 AORUS Master",         Price = 419.99m,
                SpecsJson = S("LGA1700 Socket","ATX","DDR5 до 8000MHz","4× DDR5 слота","Z790","PCIe 5.0","5x M.2","USB4 40Gbps"),
                Socket = "LGA1700", FormFactor = "ATX",  RamType = "DDR5", Chipset = "Z790",  RamSlots = 4, Image = "img/motherboard/mb-15.png" },

            // ── ASRock
            new() { CategoryId = cat["motherboard"], Brand = "ASRock",  Name = "B550 Phantom Gaming 4",    Price = 99.99m,
                SpecsJson = S("AM4 Socket","ATX","DDR4 до 4733MHz","4× DDR4 слота","B550","PCIe 4.0","2x M.2","USB 3.2"),
                Socket = "AM4",     FormFactor = "ATX",  RamType = "DDR4", Chipset = "B550",  RamSlots = 4, Image = "img/motherboard/mb-16.png" },
            new() { CategoryId = cat["motherboard"], Brand = "ASRock",  Name = "B650E PG Riptide WiFi",    Price = 199.99m,
                SpecsJson = S("AM5 Socket","ATX","DDR5 до 6400MHz","4× DDR5 слота","B650E","PCIe 5.0 x2","3x M.2","WiFi 6E"),
                Socket = "AM5",     FormFactor = "ATX",  RamType = "DDR5", Chipset = "B650E", RamSlots = 4, Image = "img/motherboard/mb-17.png" },
            new() { CategoryId = cat["motherboard"], Brand = "ASRock",  Name = "Z790 Pro RS DDR5",         Price = 199.99m,
                SpecsJson = S("LGA1700 Socket","ATX","DDR5 до 7200MHz","4× DDR5 слота","Z790","PCIe 5.0","4x M.2","2.5G LAN"),
                Socket = "LGA1700", FormFactor = "ATX",  RamType = "DDR5", Chipset = "Z790",  RamSlots = 4, Image = "img/motherboard/mb-18.png" },
            new() { CategoryId = cat["motherboard"], Brand = "ASRock",  Name = "X670E Taichi",             Price = 399.99m,
                SpecsJson = S("AM5 Socket","ATX","DDR5 до 8000MHz","4× DDR5 слота","X670E","PCIe 5.0 x2","5x M.2","WiFi 6E","Thunderbolt 4"),
                Socket = "AM5",     FormFactor = "ATX",  RamType = "DDR5", Chipset = "X670E", RamSlots = 4, Image = "img/motherboard/mb-19.png" },

            // ── Biostar
            new() { CategoryId = cat["motherboard"], Brand = "Biostar", Name = "B550MX/E Pro",             Price = 79.99m,
                SpecsJson = S("AM4 Socket","mATX","DDR4 до 4400MHz","4× DDR4 слота","B550","PCIe 4.0","1x M.2","USB 3.2","Бюджет"),
                Socket = "AM4",     FormFactor = "mATX", RamType = "DDR4", Chipset = "B550",  RamSlots = 4, Image = "img/motherboard/mb-20.png" },
            new() { CategoryId = cat["motherboard"], Brand = "Biostar", Name = "B760MX-E Pro DDR5",        Price = 89.99m,
                SpecsJson = S("LGA1700 Socket","mATX","DDR5 до 5600MHz","4× DDR5 слота","B760","PCIe 4.0","2x M.2","USB 3.2","Бюджет"),
                Socket = "LGA1700", FormFactor = "mATX", RamType = "DDR5", Chipset = "B760",  RamSlots = 4, Image = "img/motherboard/mb-21.png" },

            // ── NZXT
            new() { CategoryId = cat["motherboard"], Brand = "NZXT",    Name = "N7 B550",                  Price = 179.99m,
                SpecsJson = S("AM4 Socket","ATX","DDR4 до 4400MHz","4× DDR4 слота","B550","PCIe 4.0","2x M.2","WiFi 6","Стальная крышка"),
                Socket = "AM4",     FormFactor = "ATX",  RamType = "DDR4", Chipset = "B550",  RamSlots = 4, Image = "img/motherboard/mb-22.png" },
            new() { CategoryId = cat["motherboard"], Brand = "NZXT",    Name = "N7 Z790",                  Price = 279.99m,
                SpecsJson = S("LGA1700 Socket","ATX","DDR5 до 6400MHz","4× DDR5 слота","Z790","PCIe 5.0","4x M.2","WiFi 6E","Стальная крышка"),
                Socket = "LGA1700", FormFactor = "ATX",  RamType = "DDR5", Chipset = "Z790",  RamSlots = 4, Image = "img/motherboard/mb-23.png" },

            // ── LGA1700 / DDR4
            new() { CategoryId = cat["motherboard"], Brand = "MSI",      Name = "PRO B660M-A DDR4",          Price = 129.99m,
                SpecsJson = S("LGA1700 Socket","mATX","DDR4 до 5200MHz","4× DDR4 слота","B660","PCIe 4.0","2x M.2","USB 3.2"),
                Socket = "LGA1700", FormFactor = "mATX", RamType = "DDR4", Chipset = "B660",  RamSlots = 4, Image = "img/motherboard/mb-24.png" },
            new() { CategoryId = cat["motherboard"], Brand = "ASUS",     Name = "PRIME Z690-P DDR4",         Price = 169.99m,
                SpecsJson = S("LGA1700 Socket","ATX","DDR4 до 5333MHz","4× DDR4 слота","Z690","PCIe 5.0","3x M.2","USB 3.2"),
                Socket = "LGA1700", FormFactor = "ATX",  RamType = "DDR4", Chipset = "Z690",  RamSlots = 4, Image = "img/motherboard/mb-25.png" },
            new() { CategoryId = cat["motherboard"], Brand = "Gigabyte", Name = "Z790 UD AX DDR4",           Price = 199.99m,
                SpecsJson = S("LGA1700 Socket","ATX","DDR4 до 5600MHz","4× DDR4 слота","Z790","PCIe 5.0","4x M.2","WiFi 6E"),
                Socket = "LGA1700", FormFactor = "ATX",  RamType = "DDR4", Chipset = "Z790",  RamSlots = 4, Image = "img/motherboard/mb-26.png" },

            // ── AM4 / DDR4 — mATX
            new() { CategoryId = cat["motherboard"], Brand = "MSI",      Name = "B550M MORTAR WiFi",         Price = 149.99m,
                SpecsJson = S("AM4 Socket","mATX","DDR4 до 5100MHz","4× DDR4 слота","B550","PCIe 4.0","2x M.2","WiFi 6"),
                Socket = "AM4",     FormFactor = "mATX", RamType = "DDR4", Chipset = "B550",  RamSlots = 4, Image = "img/motherboard/mb-27.png" },
            new() { CategoryId = cat["motherboard"], Brand = "ASRock",   Name = "B550M Pro4",                Price = 109.99m,
                SpecsJson = S("AM4 Socket","mATX","DDR4 до 4733MHz","4× DDR4 слота","B550","PCIe 4.0","2x M.2","USB 3.2"),
                Socket = "AM4",     FormFactor = "mATX", RamType = "DDR4", Chipset = "B550",  RamSlots = 4, Image = "img/motherboard/mb-28.png" },

            // ── AM5 / DDR5 — mATX + High-end
            new() { CategoryId = cat["motherboard"], Brand = "ASRock",   Name = "B650M Pro RS WiFi",         Price = 159.99m,
                SpecsJson = S("AM5 Socket","mATX","DDR5 до 6400MHz","4× DDR5 слота","B650","PCIe 5.0","2x M.2","WiFi 6E"),
                Socket = "AM5",     FormFactor = "mATX", RamType = "DDR5", Chipset = "B650",  RamSlots = 4, Image = "img/motherboard/mb-29.png" },
            new() { CategoryId = cat["motherboard"], Brand = "ASUS",     Name = "TUF Gaming X670E-Plus WiFi", Price = 299.99m,
                SpecsJson = S("AM5 Socket","ATX","DDR5 до 7200MHz","4× DDR5 слота","X670E","PCIe 5.0","4x M.2","WiFi 6E"),
                Socket = "AM5",     FormFactor = "ATX",  RamType = "DDR5", Chipset = "X670E", RamSlots = 4, Image = "img/motherboard/mb-30.png" },

            // ── LGA1700 / DDR5 — mATX
            new() { CategoryId = cat["motherboard"], Brand = "Gigabyte", Name = "B760M AORUS Elite DDR5",    Price = 169.99m,
                SpecsJson = S("LGA1700 Socket","mATX","DDR5 до 7600MHz","4× DDR5 слота","B760","PCIe 4.0","3x M.2","2.5G LAN"),
                Socket = "LGA1700", FormFactor = "mATX", RamType = "DDR5", Chipset = "B760",  RamSlots = 4, Image = "img/motherboard/mb-31.png" },

            // ── Mini-ITX
            new() { CategoryId = cat["motherboard"], Brand = "ASUS",     Name = "ROG Strix B550-I Gaming",   Price = 199.99m,
                SpecsJson = S("AM4 Socket","ITX","DDR4 до 5100MHz","2× DDR4 слота","B550","PCIe 4.0","2x M.2","WiFi 6"),
                Socket = "AM4",     FormFactor = "ITX",  RamType = "DDR4", Chipset = "B550",  RamSlots = 2, Image = "img/motherboard/mb-32.png" },
            new() { CategoryId = cat["motherboard"], Brand = "ASUS",     Name = "ROG Strix B660-I Gaming WiFi", Price = 229.99m,
                SpecsJson = S("LGA1700 Socket","ITX","DDR5 до 6000MHz","2× DDR5 слота","B660","PCIe 5.0","2x M.2","WiFi 6E"),
                Socket = "LGA1700", FormFactor = "ITX",  RamType = "DDR5", Chipset = "B660",  RamSlots = 2, Image = "img/motherboard/mb-33.png" },

            // ── LGA1151 / EATX
            new() { CategoryId = cat["motherboard"], Brand = "ASUS",     Name = "ROG Maximus XI Extreme",    Price = 549.99m,
                SpecsJson = S("LGA1151 Socket","EATX","DDR4 до 4266MHz","4× DDR4 слота","Z390","PCIe 3.0","3x M.2","WiFi 5"),
                Socket = "LGA1151", FormFactor = "EATX", RamType = "DDR4", Chipset = "Z390",  RamSlots = 4, Image = "img/motherboard/mb-34.png" },
            new() { CategoryId = cat["motherboard"], Brand = "MSI",      Name = "MEG Z390 GODLIKE",          Price = 499.99m,
                SpecsJson = S("LGA1151 Socket","EATX","DDR4 до 4400MHz","4× DDR4 слота","Z390","PCIe 3.0","3x M.2","WiFi 5","Thunderbolt 3"),
                Socket = "LGA1151", FormFactor = "EATX", RamType = "DDR4", Chipset = "Z390",  RamSlots = 4, Image = "img/motherboard/mb-35.png" },

            // ── AM4 / EATX
            new() { CategoryId = cat["motherboard"], Brand = "ASUS",     Name = "ROG Crosshair VIII Extreme", Price = 629.99m,
                SpecsJson = S("AM4 Socket","EATX","DDR4 до 5100MHz","4× DDR4 слота","X570","PCIe 4.0","4x M.2","WiFi 6E","Thunderbolt 4"),
                Socket = "AM4",     FormFactor = "EATX", RamType = "DDR4", Chipset = "X570",  RamSlots = 4, Image = "img/motherboard/mb-36.png" },
            new() { CategoryId = cat["motherboard"], Brand = "Gigabyte", Name = "X570 AORUS Xtreme",         Price = 499.99m,
                SpecsJson = S("AM4 Socket","EATX","DDR4 до 5400MHz","4× DDR4 слота","X570","PCIe 4.0","3x M.2","WiFi 6","10G LAN"),
                Socket = "AM4",     FormFactor = "EATX", RamType = "DDR4", Chipset = "X570",  RamSlots = 4, Image = "img/motherboard/mb-37.png" },

            // ── AM5 / EATX
            new() { CategoryId = cat["motherboard"], Brand = "ASUS",     Name = "ROG Crosshair X670E Extreme", Price = 749.99m,
                SpecsJson = S("AM5 Socket","EATX","DDR5 до 8000MHz","4× DDR5 слота","X670E","PCIe 5.0 x2","5x M.2","WiFi 6E","Thunderbolt 4"),
                Socket = "AM5",     FormFactor = "EATX", RamType = "DDR5", Chipset = "X670E", RamSlots = 4, Image = "img/motherboard/mb-38.png" },
            new() { CategoryId = cat["motherboard"], Brand = "Gigabyte", Name = "X670E AORUS Xtreme",        Price = 849.99m,
                SpecsJson = S("AM5 Socket","EATX","DDR5 до 8400MHz","4× DDR5 слота","X670E","PCIe 5.0 x2","5x M.2","WiFi 6E","10G LAN"),
                Socket = "AM5",     FormFactor = "EATX", RamType = "DDR5", Chipset = "X670E", RamSlots = 4, Image = "img/motherboard/mb-39.png" },

            // ── LGA1700 / EATX
            new() { CategoryId = cat["motherboard"], Brand = "ASUS",     Name = "ROG Maximus Z790 Extreme",  Price = 799.99m,
                SpecsJson = S("LGA1700 Socket","EATX","DDR5 до 8000MHz","4× DDR5 слота","Z790","PCIe 5.0","5x M.2","WiFi 6E","Thunderbolt 4"),
                Socket = "LGA1700", FormFactor = "EATX", RamType = "DDR5", Chipset = "Z790",  RamSlots = 4, Image = "img/motherboard/mb-40.png" },
            new() { CategoryId = cat["motherboard"], Brand = "MSI",      Name = "MEG Z790 GODLIKE",          Price = 999.99m,
                SpecsJson = S("LGA1700 Socket","EATX","DDR5 до 8400MHz","4× DDR5 слота","Z790","PCIe 5.0","6x M.2","WiFi 6E","10G LAN"),
                Socket = "LGA1700", FormFactor = "EATX", RamType = "DDR5", Chipset = "Z790",  RamSlots = 4, Image = "img/motherboard/mb-41.png" },

            // ── LGA1851 / EATX
            new() { CategoryId = cat["motherboard"], Brand = "ASUS",     Name = "ROG Maximus Z890 Extreme",  Price = 849.99m,
                SpecsJson = S("LGA1851 Socket","EATX","DDR5 до 9000MHz","4× DDR5 слота","Z890","PCIe 5.0","5x M.2","WiFi 7","Thunderbolt 5"),
                Socket = "LGA1851", FormFactor = "EATX", RamType = "DDR5", Chipset = "Z890",  RamSlots = 4, Image = "img/motherboard/mb-42.png" },
            new() { CategoryId = cat["motherboard"], Brand = "MSI",      Name = "MEG Z890 GODLIKE",          Price = 1099.99m,
                SpecsJson = S("LGA1851 Socket","EATX","DDR5 до 9200MHz","4× DDR5 слота","Z890","PCIe 5.0","6x M.2","WiFi 7","10G LAN"),
                Socket = "LGA1851", FormFactor = "EATX", RamType = "DDR5", Chipset = "Z890",  RamSlots = 4, Image = "img/motherboard/mb-43.png" },

            // ── LGA2066 / X299 — HEDT
            new() { CategoryId = cat["motherboard"], Brand = "ASUS",     Name = "ROG Rampage VI Extreme Encore", Price = 749.99m,
                SpecsJson = S("LGA2066 Socket","EATX","DDR4 до 4266MHz","8× DDR4 слота","X299","PCIe 3.0","3x M.2","WiFi 6","Thunderbolt 3","10G LAN"),
                Socket = "LGA2066", FormFactor = "EATX", RamType = "DDR4", Chipset = "X299",  RamSlots = 8, Image = "img/motherboard/mb-44.png" },
            new() { CategoryId = cat["motherboard"], Brand = "ASUS",     Name = "ROG Strix X299-E Gaming II", Price = 399.99m,
                SpecsJson = S("LGA2066 Socket","ATX","DDR4 до 4266MHz","8× DDR4 слота","X299","PCIe 3.0","3x M.2","WiFi 5","2.5G LAN"),
                Socket = "LGA2066", FormFactor = "ATX",  RamType = "DDR4", Chipset = "X299",  RamSlots = 8, Image = "img/motherboard/mb-45.png" },
            new() { CategoryId = cat["motherboard"], Brand = "Gigabyte", Name = "X299X AORUS Master",        Price = 599.99m,
                SpecsJson = S("LGA2066 Socket","EATX","DDR4 до 4400MHz","8× DDR4 слота","X299","PCIe 3.0","3x M.2","WiFi 6","Thunderbolt 3","10G LAN"),
                Socket = "LGA2066", FormFactor = "EATX", RamType = "DDR4", Chipset = "X299",  RamSlots = 8, Image = "img/motherboard/mb-46.png" },
            new() { CategoryId = cat["motherboard"], Brand = "MSI",      Name = "MEG X299 CREATION",         Price = 549.99m,
                SpecsJson = S("LGA2066 Socket","EATX","DDR4 до 4500MHz","8× DDR4 слота","X299","PCIe 3.0","3x M.2","WiFi 5","Thunderbolt 3","10G LAN"),
                Socket = "LGA2066", FormFactor = "EATX", RamType = "DDR4", Chipset = "X299",  RamSlots = 8, Image = "img/motherboard/mb-47.png" },
            new() { CategoryId = cat["motherboard"], Brand = "ASRock",   Name = "X299 XE Gaming",            Price = 379.99m,
                SpecsJson = S("LGA2066 Socket","EATX","DDR4 до 4266MHz","8× DDR4 слота","X299","PCIe 3.0","3x M.2","10G LAN"),
                Socket = "LGA2066", FormFactor = "EATX", RamType = "DDR4", Chipset = "X299",  RamSlots = 8, Image = "img/motherboard/mb-48.png" },

            // ── TRX40 (Threadripper 3000) — HEDT
            new() { CategoryId = cat["motherboard"], Brand = "ASUS",     Name = "ROG Zenith II Extreme Alpha", Price = 949.99m,
                SpecsJson = S("TRX40 Socket","EATX","DDR4 до 4666MHz","8× DDR4 слота","TRX40","PCIe 4.0","4x M.2","WiFi 6","Thunderbolt 3","10G LAN"),
                Socket = "TRX40",   FormFactor = "EATX", RamType = "DDR4", Chipset = "TRX40", RamSlots = 8, Image = "img/motherboard/mb-49.png" },
            new() { CategoryId = cat["motherboard"], Brand = "Gigabyte", Name = "TRX40 AORUS Xtreme",        Price = 799.99m,
                SpecsJson = S("TRX40 Socket","EATX","DDR4 до 4400MHz","8× DDR4 слота","TRX40","PCIe 4.0","3x M.2","WiFi 6","Thunderbolt 3","10G LAN"),
                Socket = "TRX40",   FormFactor = "EATX", RamType = "DDR4", Chipset = "TRX40", RamSlots = 8, Image = "img/motherboard/mb-50.png" },
            new() { CategoryId = cat["motherboard"], Brand = "MSI",      Name = "TRX40 PRO WIFI",            Price = 399.99m,
                SpecsJson = S("TRX40 Socket","EATX","DDR4 до 4400MHz","8× DDR4 слота","TRX40","PCIe 4.0","3x M.2","WiFi 6","2.5G LAN"),
                Socket = "TRX40",   FormFactor = "EATX", RamType = "DDR4", Chipset = "TRX40", RamSlots = 8, Image = "img/motherboard/mb-51.png" },
            ...
            new() { CategoryId = cat["psu"], Brand = "Cooler Master", Name = "MWE 600W 80+ Bronze",              Price = 49.99m,
                SpecsJson = S("600W","80+ Bronze","Немодульный","ATX 2.4","Гарантия 3 года"), Wattage = 600 },
            new() { CategoryId = cat["psu"], Brand = "be quiet!",     Name = "System Power 10 700W 80+ Bronze",  Price = 64.99m,
                SpecsJson = S("700W","80+ Bronze","Немодульный","ATX 2.4","Гарантия 3 года"), Wattage = 700 },
            new() { CategoryId = cat["psu"], Brand = "Corsair",       Name = "CX750M 750W 80+ Bronze",           Price = 79.99m,
                SpecsJson = S("750W","80+ Bronze","Частично модульный","ATX 2.4","Гарантия 5 лет"), Wattage = 750 },
            new() { CategoryId = cat["psu"], Brand = "EVGA",          Name = "850 BQ 850W 80+ Bronze",           Price = 99.99m,
                SpecsJson = S("850W","80+ Bronze","Частично модульный","ATX 2.4","Гарантия 5 лет"), Wattage = 850 },

            // ── Coolers ────────────────────────────────────────────────────────

            // Budget Air — single tower
            new() { CategoryId = cat["cooler"], Brand = "ID-Cooling",    Name = "SE-224-XT",                   Price = 29.99m,
                SpecsJson = S("Башенное","1× 120mm","4 тепловые трубки","RGB","180W TDP","32.5 дБ"), MaxTdp = 180 },
            new() { CategoryId = cat["cooler"], Brand = "be quiet!",     Name = "Pure Rock 2",                 Price = 39.99m,
                SpecsJson = S("Башенное","1× 120mm","4 тепловые трубки","Без подсветки","150W TDP","26.8 дБ"), MaxTdp = 150 },
            new() { CategoryId = cat["cooler"], Brand = "Cooler Master", Name = "Hyper 212 Halo",              Price = 34.99m,
                SpecsJson = S("Башенное","1× 120mm","4 тепловые трубки","ARGB","150W TDP","27 дБ"), MaxTdp = 150 },
            new() { CategoryId = cat["cooler"], Brand = "DeepCool",      Name = "AK400",                       Price = 39.99m,
                SpecsJson = S("Башенное","1× 120mm","4 тепловые трубки","Без подсветки","220W TDP","29 дБ"), MaxTdp = 220 },
            new() { CategoryId = cat["cooler"], Brand = "Noctua",        Name = "NH-U12S redux",               Price = 49.99m,
                SpecsJson = S("Башенное","1× 120mm","4 тепловые трубки","Без подсветки","165W TDP","23.1 дБ"), MaxTdp = 165 },

            // Mid Air — dual tower
            new() { CategoryId = cat["cooler"], Brand = "Thermalright",  Name = "Peerless Assassin 120 SE",    Price = 44.99m,
                SpecsJson = S("Башенное","2× 120mm","6 тепловых трубок","Без подсветки","265W TDP","25.6 дБ"), MaxTdp = 265 },
            new() { CategoryId = cat["cooler"], Brand = "DeepCool",      Name = "AK620",                       Price = 54.99m,
                SpecsJson = S("Башенное","2× 120mm","6 тепловых трубок","Без подсветки","260W TDP","28 дБ"), MaxTdp = 260 },
            new() { CategoryId = cat["cooler"], Brand = "be quiet!",     Name = "Dark Rock Pro 4",             Price = 89.99m,
                SpecsJson = S("Башенное","3× 120mm","7 тепловых трубок","Без подсветки","250W TDP","24.3 дБ"), MaxTdp = 250 },
            new() { CategoryId = cat["cooler"], Brand = "Noctua",        Name = "NH-D15",                      Price = 99.99m,
                SpecsJson = S("Башенное","2× 140mm","6 тепловых трубок","Без подсветки","220W TDP","24.6 дБ"), MaxTdp = 220 },
            new() { CategoryId = cat["cooler"], Brand = "Cooler Master", Name = "MA624 Stealth",               Price = 89.99m,
                SpecsJson = S("Башенное","2× 120mm","6 тепловых трубок","ARGB","280W TDP","27 дБ"), MaxTdp = 280 },

            // AIO 120mm
            new() { CategoryId = cat["cooler"], Brand = "Arctic",        Name = "Liquid Freezer II 120",       Price = 59.99m,
                SpecsJson = S("AIO Водяное","1× 120mm","120mm Радиатор","Без подсветки","200W TDP","22 дБ"), MaxTdp = 200 },
            new() { CategoryId = cat["cooler"], Brand = "Corsair",       Name = "H45 120mm",                   Price = 74.99m,
                SpecsJson = S("AIO Водяное","1× 120mm","120mm Радиатор","RGB","200W TDP","28 дБ"), MaxTdp = 200 },

            // AIO 240mm
            new() { CategoryId = cat["cooler"], Brand = "Arctic",        Name = "Liquid Freezer III 240",      Price = 74.99m,
                SpecsJson = S("AIO Водяное","2× 120mm","240mm Радиатор","ARGB","275W TDP","22.5 дБ"), MaxTdp = 275 },
            new() { CategoryId = cat["cooler"], Brand = "be quiet!",     Name = "Pure Loop 2 240",             Price = 89.99m,
                SpecsJson = S("AIO Водяное","2× 120mm","240mm Радиатор","Без подсветки","250W TDP","32.3 дБ"), MaxTdp = 250 },
            new() { CategoryId = cat["cooler"], Brand = "Corsair",       Name = "H100i Elite Capellix 240mm",  Price = 129.99m,
                SpecsJson = S("AIO Водяное","2× 120mm","240mm Радиатор","ARGB","300W TDP","36 дБ"), MaxTdp = 300 },
            new() { CategoryId = cat["cooler"], Brand = "NZXT",          Name = "Kraken 240",                  Price = 149.99m,
                SpecsJson = S("AIO Водяное","2× 120mm","240mm Радиатор","ARGB","300W TDP","33.9 дБ"), MaxTdp = 300 },

            // AIO 280mm
            new() { CategoryId = cat["cooler"], Brand = "Arctic",        Name = "Liquid Freezer III 280",      Price = 84.99m,
                SpecsJson = S("AIO Водяное","2× 140mm","280mm Радиатор","ARGB","300W TDP","22.5 дБ"), MaxTdp = 300 },

            // AIO 360mm
            new() { CategoryId = cat["cooler"], Brand = "Arctic",        Name = "Liquid Freezer III 360",      Price = 89.99m,
                SpecsJson = S("AIO Водяное","3× 120mm","360mm Радиатор","ARGB","350W TDP","22.5 дБ"), MaxTdp = 350 },
            new() { CategoryId = cat["cooler"], Brand = "Corsair",       Name = "H150i Elite Capellix 360mm",  Price = 179.99m,
                SpecsJson = S("AIO Водяное","3× 120mm","360mm Радиатор","ARGB","400W TDP","37.7 дБ"), MaxTdp = 400 },
            new() { CategoryId = cat["cooler"], Brand = "NZXT",          Name = "Kraken 360",                  Price = 199.99m,
                SpecsJson = S("AIO Водяное","3× 120mm","360mm Радиатор","ARGB","400W TDP","33.9 дБ"), MaxTdp = 400 },

            // ── Cases ──────────────────────────────────────────────────────────

            // Mini-ITX
            new() { CategoryId = cat["case"], Brand = "NZXT",           Name = "H210",                 Price = 89.99m,
                SpecsJson = S("Mini-ITX корпус","Поддержка: Mini-ITX","2× 120mm предустановлено","Tempered Glass","USB-C 3.2, 2× USB 3.0","3× 2.5\" + 1× 3.5\" накопителя"),
                SupportedFormFactorsJson = J("ITX") },
            new() { CategoryId = cat["case"], Brand = "Cooler Master",  Name = "NR200P",               Price = 99.99m,
                SpecsJson = S("Mini-ITX корпус","Поддержка: Mini-ITX","2× 120mm предустановлено","Tempered Glass","2× USB 3.0","3× 2.5\" + 1× 3.5\" накопителя"),
                SupportedFormFactorsJson = J("ITX") },
            new() { CategoryId = cat["case"], Brand = "Fractal Design", Name = "Node 304",             Price = 89.99m,
                SpecsJson = S("Mini-ITX корпус","Поддержка: Mini-ITX","3× 92mm предустановлено","Airflow","2× USB 3.0","6× 3.5\"/2.5\" накопителей"),
                SupportedFormFactorsJson = J("ITX") },
            new() { CategoryId = cat["case"], Brand = "Lian Li",        Name = "TU150",                Price = 109.99m,
                SpecsJson = S("Mini-ITX корпус","Поддержка: Mini-ITX","0 предустановлено","Tempered Glass","USB-C 3.2, 2× USB 3.0","2× 2.5\" накопителя"),
                SupportedFormFactorsJson = J("ITX") },
            new() { CategoryId = cat["case"], Brand = "Phanteks",       Name = "Evolv Shift 2 Air",    Price = 99.99m,
                SpecsJson = S("Mini-ITX корпус","Поддержка: Mini-ITX","1× 140mm предустановлено","Airflow","2× USB 3.0","2× 2.5\" + 1× 3.5\" накопителя"),
                SupportedFormFactorsJson = J("ITX") },

            // mATX
            new() { CategoryId = cat["case"], Brand = "Cooler Master",  Name = "Q300L V2",             Price = 64.99m,
                SpecsJson = S("mATX Micro Tower","Поддержка: mATX, ITX","0 предустановлено","Airflow","USB-C 3.2","2× 2.5\" + 1× 3.5\" накопителя"),
                SupportedFormFactorsJson = J("mATX","ITX") },
            new() { CategoryId = cat["case"], Brand = "Phanteks",       Name = "Eclipse P300A Mesh",   Price = 64.99m,
                SpecsJson = S("mATX Mid Tower","Поддержка: mATX, ITX","1× 120mm предустановлено","Airflow","2× USB 3.0","2× 2.5\" + 2× 3.5\" накопителя"),
                SupportedFormFactorsJson = J("mATX","ITX") },
            new() { CategoryId = cat["case"], Brand = "Fractal Design", Name = "Pop Mini Air",         Price = 99.99m,
                SpecsJson = S("mATX Mid Tower","Поддержка: mATX, ITX","3× 120mm предустановлено","Airflow","USB-C 3.2, 2× USB 3.0","3× 3.5\" + 3× 2.5\" накопителя"),
                SupportedFormFactorsJson = J("mATX","ITX") },
            new() { CategoryId = cat["case"], Brand = "NZXT",           Name = "H5 Flow Compact",      Price = 94.99m,
                SpecsJson = S("mATX Mid Tower","Поддержка: mATX, ITX","2× 120mm предустановлено","Airflow","USB-C 3.2, USB 3.0","2× 2.5\" + 1× 3.5\" накопителя"),
                SupportedFormFactorsJson = J("mATX","ITX") },
            new() { CategoryId = cat["case"], Brand = "Lian Li",        Name = "LANCOOL 205M",         Price = 89.99m,
                SpecsJson = S("mATX Mid Tower","Поддержка: mATX, ITX","2× 140mm предустановлено","Airflow","2× USB 3.0","2× 2.5\" + 2× 3.5\" накопителя"),
                SupportedFormFactorsJson = J("mATX","ITX") },

            // ATX
            new() { CategoryId = cat["case"], Brand = "Fractal Design", Name = "North ATX",            Price = 109.99m,
                SpecsJson = S("ATX Mid Tower","Поддержка: ATX, mATX, ITX","2× 140mm предустановлено","Airflow","USB-C 3.2, 2× USB 3.0","2× 2.5\" + 2× 3.5\" накопителя"),
                SupportedFormFactorsJson = J("ATX","mATX","ITX") },
            new() { CategoryId = cat["case"], Brand = "Lian Li",        Name = "O11 Dynamic EVO",      Price = 149.99m,
                SpecsJson = S("ATX Mid Tower","Поддержка: ATX, mATX, ITX","0 предустановлено","Tempered Glass","USB-C 3.2, 2× USB 3.0","4× 2.5\" + 2× 3.5\" накопителя"),
                SupportedFormFactorsJson = J("ATX","mATX","ITX") },
            new() { CategoryId = cat["case"], Brand = "Corsair",        Name = "4000D Airflow",        Price = 89.99m,
                SpecsJson = S("ATX Mid Tower","Поддержка: ATX, mATX, ITX","2× 120mm предустановлено","Airflow","USB-C 3.1, USB 3.0","2× 2.5\" + 2× 3.5\" накопителя"),
                SupportedFormFactorsJson = J("ATX","mATX","ITX") },
            new() { CategoryId = cat["case"], Brand = "be quiet!",      Name = "Pure Base 500DX",      Price = 99.99m,
                SpecsJson = S("ATX Mid Tower","Поддержка: ATX, mATX, ITX","3× 140mm предустановлено","Airflow","USB-C 3.2, USB 3.0","2× 2.5\" + 2× 3.5\" накопителя"),
                SupportedFormFactorsJson = J("ATX","mATX","ITX") },
            new() { CategoryId = cat["case"], Brand = "NZXT",           Name = "H7 Flow",              Price = 129.99m,
                SpecsJson = S("ATX Mid Tower","Поддержка: ATX, mATX, ITX","3× 120mm предустановлено","Airflow","USB-C 3.2, 2× USB 3.0","4× 2.5\" + 1× 3.5\" накопителя"),
                SupportedFormFactorsJson = J("ATX","mATX","ITX") },

            // EATX
            new() { CategoryId = cat["case"], Brand = "Corsair",        Name = "5000X RGB",            Price = 189.99m,
                SpecsJson = S("EATX Full Tower","Поддержка: EATX, ATX, mATX, ITX","3× 120mm предустановлено","Tempered Glass","USB-C 3.1, 2× USB 3.0","4× 2.5\" + 2× 3.5\" накопителя"),
                SupportedFormFactorsJson = J("EATX","ATX","mATX","ITX") },
            new() { CategoryId = cat["case"], Brand = "Lian Li",        Name = "PC-O11 Dynamic XL",    Price = 179.99m,
                SpecsJson = S("EATX Full Tower","Поддержка: EATX, ATX, mATX, ITX","0 предустановлено","Tempered Glass","USB-C 3.2, 2× USB 3.0","6× 2.5\" + 2× 3.5\" накопителя"),
                SupportedFormFactorsJson = J("EATX","ATX","mATX","ITX") },
            new() { CategoryId = cat["case"], Brand = "Fractal Design", Name = "Meshify 2 XL",         Price = 199.99m,
                SpecsJson = S("EATX Full Tower","Поддержка: EATX, ATX, mATX, ITX","3× 140mm предустановлено","Airflow","USB-C 3.2, 2× USB 3.0","4× 2.5\" + 4× 3.5\" накопителя"),
                SupportedFormFactorsJson = J("EATX","ATX","mATX","ITX") },
            new() { CategoryId = cat["case"], Brand = "be quiet!",      Name = "Dark Base 901",        Price = 219.99m,
                SpecsJson = S("EATX Full Tower","Поддержка: EATX, ATX, mATX, ITX","3× 140mm предустановлено","Airflow","USB-C 3.2, 2× USB 3.0","4× 2.5\" + 3× 3.5\" накопителя"),
                SupportedFormFactorsJson = J("EATX","ATX","mATX","ITX") },
            new() { CategoryId = cat["case"], Brand = "Thermaltake",    Name = "View 51 TG ARGB",      Price = 219.99m,
                SpecsJson = S("EATX Full Tower","Поддержка: EATX, ATX, mATX, ITX","3× 120mm предустановлено","Tempered Glass","USB-C 3.0, 2× USB 3.0","2× 2.5\" + 2× 3.5\" накопителя"),
                SupportedFormFactorsJson = J("EATX","ATX","mATX","ITX") },
        };
